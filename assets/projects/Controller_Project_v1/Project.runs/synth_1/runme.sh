...
HD_PWD='/home/daniel/Project/Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_topmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_topmodule.tcl
